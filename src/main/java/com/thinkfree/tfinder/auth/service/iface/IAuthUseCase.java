...
public interface IAuthUseCase {
     ...
     */
    MemberSignupResponse signUp(SignupRequest dto) throws BusinessException;
     ...
     */
    LoginResult login(LoginRequest dto) throws BusinessException;
     ...
     */
    LoginResult refresh(String refreshToken) throws BusinessException;
